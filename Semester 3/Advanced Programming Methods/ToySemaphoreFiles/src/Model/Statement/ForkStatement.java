...
public class ForkStatement implements IStatement{
    ...
    public ProgramState execute(ProgramState state) throws IOException, ToyLanguageInterpreterException {
        ...
        return new ProgramState(forkExeStack, state.getSymbolTable().createDictionaryDuplicate(), state.getHeap(),state.getToySemaphoreTable(), state.getOutputList(), statement.cloneStatement(), state.getFileTable());
        //return state;
    }
