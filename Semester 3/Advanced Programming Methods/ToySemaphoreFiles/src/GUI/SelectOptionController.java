...
public class SelectOptionController implements Initializable {
    ...
    private void buildProgramStatements()
    {
        ...
        IStatement ex13 = buildExample(
                new DeclarationStatement("v1", new RefType(new IntType())), new DeclarationStatement("cnt", new IntType()),
                new NewStatement("v1", new ConstantExpression(new IntValue(2))),
                new NewSemaphoreStatement("cnt", new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(1))),
                new ForkStatement(buildExample(
                        new AcquireStatement("cnt"),
                        new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)),OperationSelection.MULTIPLY)),
                        new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                        new ReleaseStatement("cnt")
                                        )),
                new ForkStatement(buildExample(new AcquireStatement("cnt"),
                        new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(10)),OperationSelection.MULTIPLY)),
                        new WriteHeapStatement("v1", new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(2)),OperationSelection.MULTIPLY)),
                        new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                        new ReleaseStatement("cnt")
                )),
                new AcquireStatement("cnt"),
                new PrintStatement(new ArithmeticExpression(new ReadHeapExpression(new VariableExpression("v1")), new ConstantExpression(new IntValue(1)),OperationSelection.MINUS)),
                new ReleaseStatement("cnt")
        );
