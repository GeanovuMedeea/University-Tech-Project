...
public class ForkStatement implements IStatement{
    ...
    public ProgramState execute(ProgramState state) throws IOException, ToyLanguageInterpreterException {
        ...
        MyIStack<MyIDictionary<String, Value>> newSymTable = state.getSymbolTable().createStackDuplicate();
        return new ProgramState(forkExeStack, newSymTable, state.getHeap(), state.getProcTable(),state.getOutputList(), statement.cloneStatement(), state.getFileTable());
        //return state;
    }
