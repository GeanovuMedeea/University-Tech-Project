...
import Collection.SemaphoreTable.MySemaphoreTable;
...
public class ProgramState {
    ...
    public ProgramState(MyStack<IStatement> programStateMyStack, MyIDictionary<String, Value> symbolTable, MyIHeap<Integer,Value> heap,MyISemaphoreTable semaphoreTable, MyIList<Value> outputList, IStatement originalProgram, MyIDictionary<StringValue,BufferedReader> fileTable) {
    ...
    public ProgramState(Boolean flag, MyStack<IStatement> programStateMyStack, MyIDictionary<String, Value> symbolTable, MyIHeap<Integer,Value> heap, MyISemaphoreTable semaphoreTable, MyIList<Value> outputList, IStatement originalProgram, MyIDictionary<StringValue,BufferedReader> fileTable) {
        executionStack = programStateMyStack;
        this.symbolTable = symbolTable;
        this.heap = heap;
        this.outputList = outputList;
    ...
    public void setState(MyStack<IStatement> programStateMyStack, MyIDictionary<String, Value> symbolTable, MyIHeap<Integer,Value> heap, MyIList<Value> outputList, IStatement originalProgram, MyIDictionary<StringValue,BufferedReader> fileTable)
    {   executionStack = programStateMyStack;
        this.symbolTable = symbolTable;
        this.heap = heap;
        this.outputList = outputList;
    ...
    public void setExecutionStack(MyIStack<IStatement> t) {this.executionStack = t;}
    ...
    public String semaphoreTableToString() throws ToyLanguageInterpreterException {
