...
public class LogicExpression implements Expression{
    ...
    private BoolValue getValue(Expression expression, MyIDictionary<String, Value> symTable) throws ToyLanguageInterpreterException {
    ...
    public Value evaluate(MyIDictionary<String, Value> symbolTable) throws ToyLanguageInterpreterException {
        BoolValue leftValue = getValue(expression1, symbolTable);
        BoolValue rightValue = getValue(expression2, symbolTable);
