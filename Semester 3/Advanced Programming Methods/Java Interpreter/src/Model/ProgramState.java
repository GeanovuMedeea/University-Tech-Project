...
public class ProgramState {
    ...
    public ProgramState(MyStack<IStatement> programStateMyStack, MyIDictionary<String, Value> symbolTable, MyIList<Value> outputList, IStatement originalProgram, MyIDictionary<StringValue,BufferedReader> fileTable) {
