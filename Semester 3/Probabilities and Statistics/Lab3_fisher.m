...
#we'll solve the first exercise, using the fisher distribution, which is continuous
n1=input('First degree of freedom (n1)= ');
n2=input('Second degreee of freedom (n2)=');
p1=fcdf(0,n1,n2);
printf('P(X<=0)=%1.6f\n',p1);
