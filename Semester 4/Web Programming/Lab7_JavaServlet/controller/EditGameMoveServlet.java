...
@WebServlet(name = "EditGameMoveServlet", value = "/EditGameMoveServlet")
public class EditGameMoveServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            logger.info("gid:"+gid);
            logger.info("gsid:"+gsid);
            logger.info("gsid:"+move);
            gameMoveDAO.updateMove(gid,gsid,move);
