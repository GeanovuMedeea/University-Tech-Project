...
segment data use32 class=data
    ...
    access_mode2 db "a", 0       ; file access mode:
                                ; r - opens a file for reading. The file must exist.
    file_descriptor2 dd -1       ; variable to hold the file descriptor
    
    len equ 100                 ; maximum number of characters to read
    nr_car_citite dd 0 ; nr car fisier
    text resb len    ; string to hold the text which is read from file
